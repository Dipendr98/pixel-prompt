      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <Card>
          <CardHeader className="pb-4">
            <h2 className="text-lg font-semibold" data-testid="text-login-title">Welcome back</h2>
          </CardHeader>
          <CardContent>
            ...
            <a href="/api/auth/google" className="w-full">
              <Button type="button" variant="outline" className="w-full gap-2" data-testid="button-google-login">
